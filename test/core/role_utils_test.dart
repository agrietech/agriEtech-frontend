...
void main() {
  group('RoleUtils - Alert Permissions', () {
    test('only officers, agents, and admin can create alerts', () {
      expect(RoleUtils.canCreateAlerts(UserRole.regionalOfficer), isTrue);
      expect(RoleUtils.canCreateAlerts(UserRole.zonalOfficer), isTrue);
  ...
  group('RoleUtils - Farm Management Permissions', () {
    test('farmers, agents, officers, and admin can manage farms', () {
      ...
      expect(RoleUtils.canManageFarms(UserRole.zonalOfficer), isTrue);
      expect(RoleUtils.canManageFarms(UserRole.regionalOfficer), isTrue);
  ...
  group('RoleUtils - Analytics & Export Permissions', () {
    test('researchers, officers, and admin can view analytics and export', () {
      ...
      expect(RoleUtils.canViewAnalytics(UserRole.regionalOfficer), isTrue);
      expect(RoleUtils.canViewAnalytics(UserRole.zonalOfficer), isTrue);
      ...
      expect(RoleUtils.canExportData(UserRole.regionalOfficer), isTrue);
      expect(RoleUtils.canExportData(UserRole.zonalOfficer), isTrue);
  ...
  group('RoleUtils - Helper Checkers & Display Names', () {
    test('role type checkers', () {
      ...
      expect(RoleUtils.isOfficer(UserRole.zonalOfficer), isTrue);
      expect(RoleUtils.isOfficer(UserRole.regionalOfficer), isTrue);
      expect(RoleUtils.isZonalOfficer(UserRole.zonalOfficer), isTrue);
      expect(RoleUtils.isRegionalOfficer(UserRole.regionalOfficer), isTrue);
    ...
    test('role display names and descriptions', () {
      ...
      expect(RoleUtils.getRoleDisplayName(UserRole.zonalOfficer), equals('Zonal Officer'));
      expect(RoleUtils.getRoleDisplayName(UserRole.regionalOfficer), equals('Regional Officer'));
      ...
      expect(RoleUtils.getRolePermissions(UserRole.zonalOfficer), contains('Zonal administrative oversight'));
      expect(RoleUtils.getRolePermissions(UserRole.regionalOfficer), contains('Regional administrative oversight'));
