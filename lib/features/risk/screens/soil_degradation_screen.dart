...
final soilDegradationDetailProvider = FutureProvider.family<Map<String, dynamic>, EthiopiaWoredaPreset>((ref, preset) async {
  ...
  return {
    'erosionMetrics': {
      'annualSoilLossTonsPerHa': 12.4,
      'riskLevel': 'MODERATE',
      'tolerableSoilLoss': 10.0,
      'statusMessage': 'Erosion within manageable threshold; vegetative bunds recommended.',
    },
    'rusleFactors': {
      'rFactor': 320.0,
      'kFactor': 0.22,
    ...
    'nutrientDepletion': {
      'nitrogenKgPerHa': -24.5,
      'phosphorusKgPerHa': -8.2,
      'potassiumKgPerHa': -14.0,
      'soilOrganicMatterPct': 2.4,
    },
    'chemicalDegradation': {
      'ph': 6.2,
      'salinityDsM': 0.45,
      'acidityStatus': 'Slightly Acidic (Ideal for Cereals)',
    },
    'conservationInterventions': {
      'am': [
        'የድንጋይ እርከን እና የሣር ክትር (Fanya Juu terraces) ማዘጋጀት',
        'የቨርሚኮምፖስትና የተፈጥሮ ማዳበሪያ አጠቃቀምን ማሳደግ',
        'የአፈር እርጥበት ጠባቂ ሰብሎችን (Legume Cover Crops) ማፈራረቅ',
      ],
      'en': [
        'Construct Fanya Juu stone and grass terraces along contours',
        'Incorporate vermicompost and manure to restore soil organic matter',
        'Practice legume cover cropping to replenish nitrogen and retain moisture',
      ],
    },
  };
});
