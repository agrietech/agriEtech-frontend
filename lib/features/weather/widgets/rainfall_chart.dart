...
class RainfallChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      container: true,
      label: '7-Day Precipitation Chart, Total ${totalRain.toStringAsFixed(1)} mm, $rainyDaysCount rainy days expected',
      child: Column(
          ...
          Expanded(
            child: LayoutBuilder(
              builder: (context, constraints) {
                final availableHeight = (constraints.maxHeight - 74).clamp(10.0, constraints.maxHeight);
                ...
                return Row(
                  ...
                  children: List.generate(daily.time.length, (index) {
                    ...
                    final displayDate = isToday ? l10n.translate('today') : monthDay;

                    return Expanded(
                      child: Tooltip(
                        message: '$displayDate\nPrecipitation: ${precip.toStringAsFixed(1)} mm\nProbability: ${prob.round()}%',
                        preferBelow: false,
                        child: Semantics(
                          label: '$displayDate: ${precip.toStringAsFixed(1)} mm precipitation, ${prob.round()}% chance',
                          child: Padding(
